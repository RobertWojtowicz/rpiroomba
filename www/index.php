...
<!--Start modification for Roomba part 1-->
      <script src="roomba/jquery-3.6.0.min.js"></script>
						...
						<tr>
                            ...
                            <td>
                                <form method="post">
									...
									<input type="button" value="90&deg" name="camera_90" onclick="runCommand(event);"><br>
									<input type="button" value="LED On" name="led_on" onclick="runCommand(event);">
									<input type="button" value="LED Off" name="led_off" onclick="runCommand(event);">
								</form>
                            </td>						
                        <tr>
